...
jpeg(file = paste0("/project/6003429/myles_lab/abc_gwas/big_gwas_analysis/gwas/mlmm_gwas/standard_manhattans/",pheno_arg,"_std_manhat.jpeg"), width = 800, height = 400)
...
write.table(std_pvals, file = paste0("/project/6003429/myles_lab/abc_gwas/big_gwas_analysis/gwas/mlmm_gwas/standard_pvals/",pheno_arg,"_std_pvals.csv"), quote = F, sep = ",", row.names = F)

jpeg(file = paste0("/project/6003429/myles_lab/abc_gwas/big_gwas_analysis/gwas/mlmm_gwas/standard_qq/",pheno_arg,"_std_qq.jpeg"), width = 500, height = 500)
qqplot <- qq(std_pvals[,2], main = "standard MLM")
dev.off()

jpeg(file = paste0("/project/6003429/myles_lab/abc_gwas/big_gwas_analysis/gwas/mlmm_gwas/mlmm_manhattans/",pheno_arg,"_mlmm_manhat.jpeg"), width = 800, height = 400)
...
write.table(mlmm_pvals, file = paste0("/project/6003429/myles_lab/abc_gwas/big_gwas_analysis/gwas/mlmm_gwas/mlmm_pvals/",pheno_arg,"_mlmm_pvals.csv"), quote = F, sep = ",", row.names = F)

jpeg(file = paste0("/project/6003429/myles_lab/abc_gwas/big_gwas_analysis/gwas/mlmm_gwas/mlmm_qq/",pheno_arg,"_mlmm_qq.jpeg"), width = 500, height = 500)
qqplot <- qq(mlmm_pvals[,2], main = "optimal MLMM")
dev.off()

var <- as.data.frame(gwas_output[["RSSout"]])
write.table(var, file = paste0("/project/6003429/myles_lab/abc_gwas/big_gwas_analysis/gwas/mlmm_gwas/rss/",pheno_arg,"_snp_variation.csv"), quote = F, sep = ",", row.names = F)
