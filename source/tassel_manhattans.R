...
for (i in pheno_list) {
  ...
  jpeg(file=paste0("/project/6003429/myles_lab/abc_gwas/big_gwas_analysis/gwas/tassel_gwas/tassel_manhattans/",i,"_tassel_man.jpeg"), width = 800, height = 400)
  manhattan(manhattan_table, main = long[i], suggestiveline=F, genomewideline=-log10(0.05/211156), highlight = vineland_snps, chrlabs = chromos, ylim = c(0,max_p))
  dev.off()
  jpeg(file=paste0("/project/6003429/myles_lab/abc_gwas/big_gwas_analysis/gwas/tassel_gwas/tassel_qq/",i,"_tassel_qq.jpeg"), width = 500, height = 500)
