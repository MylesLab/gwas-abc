...
pdf(file = paste0("/project/6003429/myles_lab/abc_gwas/big_gwas_analysis/gwas/mlmm_gwas/standard_manhattans/",pheno_arg,"_std_manhat.pdf"))
...
pdf(file = paste0("/project/6003429/myles_lab/abc_gwas/big_gwas_analysis/gwas/mlmm_gwas/standard_qq/",pheno_arg,"_std_qq.pdf"))
qqplot <- qq(std_pvals[,2], main = "standard MLM")
dev.off()

pdf(file = paste0("/project/6003429/myles_lab/abc_gwas/big_gwas_analysis/gwas/mlmm_gwas/mlmm_manhattans/",pheno_arg,"_mlmm_manhat.pdf"))
...
pdf(file = paste0("/project/6003429/myles_lab/abc_gwas/big_gwas_analysis/gwas/mlmm_gwas/mlmm_qq/",pheno_arg,"_mlmm_qq.pdf"))
